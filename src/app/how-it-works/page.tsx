...
export default function HowItWorksPage() {
  const steps = [
    ...
    { step: 4, title: 'Secure Payment', desc: 'Pay via your Uteo wallet or M-Pesa. Your payment is held in escrow until the session is complete, protecting both parties.', icon: 'M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z' },
    ...
    <>
      ...
      <section className="relative h-[40vh] min-h-[320px] flex items-end pb-12 overflow-hidden">
        ...
        <div className="relative z-10 mx-auto max-w-[1400px] px-6 lg:px-10 w-full">
          ...
          <h1 className="text-4xl lg:text-6xl font-black text-white">How Uteo Works</h1>
      ...
      <div className="mx-auto max-w-[1400px] px-6 lg:px-10 py-20 lg:py-28">
          ...
          {steps.map((item) => (
            <div key={item.step} className="relative bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 p-8">
              <div className="flex items-center gap-4 mb-5">
                <div className="w-14 h-14 rounded-2xl bg-[#F77B0F] text-white flex items-center justify-center flex-shrink-0">
        ...
        <div className="text-center">
          <Link href="/register" className="px-8 py-3.5 bg-[#F77B0F] text-white font-semibold rounded-xl hover:bg-[#e06a0d] transition-colors shadow-lg inline-block">
            Get Started Now
          </Link>
        </div>
      </div>

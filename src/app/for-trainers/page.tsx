    ...
    <div>
      <section className="bg-gradient-to-br from-primary-600 to-primary-800 text-white py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-4xl sm:text-5xl font-extrabold mb-6">Grow Your Training Business with SkillSasa</h1>
          <p className="text-lg text-primary-200 max-w-2xl mx-auto mb-8">
            Join Kenya&apos;s largest trainer marketplace. Reach more clients, manage bookings effortlessly, and get paid securely.
          </p>
      ...
      <section className="py-20 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <h2 className="text-3xl font-bold text-gray-900 dark:text-white text-center mb-12">Why Trainers Choose SkillSasa</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {[
            ...
            <div key={i} className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6">
              <div className="w-12 h-12 rounded-lg bg-primary-50 dark:bg-primary-900/30 text-primary-500 flex items-center justify-center mb-4">
      ...
      <section className="py-16 bg-gray-50 dark:bg-gray-800/50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <Link href="/register?role=TRAINER" className="px-8 py-3.5 bg-primary-500 text-white font-semibold rounded-xl hover:bg-primary-600 transition-colors shadow-lg inline-block">
            Create Your Profile
          </Link>
        </div>
      </section>

...
function ShareBar({ jobId, jobTitle }: { jobId: string; jobTitle: string }) {
  ...
  return (
    <div className="relative">
      <button
        type="button"
        onClick={() => setOpen((o) => !o)}
        className="inline-flex items-center gap-1.5 text-xs font-semibold text-gray-500 dark:text-gray-400 hover:text-[#192C67] dark:hover:text-white transition-colors px-2.5 py-1 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700"
      >
        ...
        <>
          ...
          <div className="absolute right-0 top-full mt-1.5 z-40 w-52 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 py-1 overflow-hidden">
            ...
            <a
              ...
              className="flex items-center gap-2.5 px-3.5 py-2 text-sm text-[#0077b5] hover:bg-[#0077b5]/10 transition-colors"
            >
            ...
            <a
              ...
              target="_blank" rel="noopener noreferrer"
              onClick={() => setOpen(false)}
              className="flex items-center gap-2.5 px-3.5 py-2 text-sm text-gray-900 dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors"
            >
            ...
            <a
              ...
              target="_blank" rel="noopener noreferrer"
              onClick={() => setOpen(false)}
              className="flex items-center gap-2.5 px-3.5 py-2 text-sm text-[#25d366] hover:bg-[#25d366]/10 transition-colors"
            >
        ...
        <div className="flex-1 space-y-6">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 p-6">
            ...
            <div className="flex items-center justify-between mt-1">
              ...
              <ShareBar jobId={job.id} jobTitle={job.title} />
            </div>
          </div>
